...
public class KrScriptConfig {
    ...
    private final static String CUSTOM_DIR = "custom";
    private final static String CUSTOM_DIR_DEFAULT = "file:///android_asset/kr-script/custom";
    ...
    public KrScriptConfig init(Context context) {
        if (configInfo == null) {
            ...
            configInfo.put(CUSTOM_DIR, CUSTOM_DIR_DEFAULT);
            ...
            if (getCustomDir() != null && !getCustomDir().isEmpty()) {
                new ExtractAssets(context).extractResources(getCustomDir());
            }
        }
    ...
    private String getCustomDir() {
        if (configInfo != null && configInfo.containsKey(CUSTOM_DIR)) {
            return configInfo.get(CUSTOM_DIR);
        }
        return CUSTOM_DIR_DEFAULT;
    }
